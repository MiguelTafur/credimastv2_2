...
<main class="app-content">
  ...
  <div class="alert alert-light alert-dismissible fade show font-monospace" role="alert">
    ...
    Recuerda que los <strong class="fst-italic">Pagos</strong> y <strong class="fst-italic">Préstamos</strong> realizados serán registrados con la fecha del resumen pendiente
