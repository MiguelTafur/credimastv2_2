            ...
            <form class="row g-3" id="formCliente" name="formCliente">
              ...
              <div class="col-md-6">
                <div class="form-floating mb-3">
                  <input type="text" class="form-control valid" id="txtIdentificacion" name="txtIdentificacion" placeholder="Identificación del Cliente">
              ...
              <div class="col-md-6">
                <div class="form-floating mb-3">
                  ...
                  <label for="txtDireccion1">Dirección del Negocio</label>
                </div>
              </div>
