...
<div class="alert alert-light alert-dismissible fade show font-monospace" role="alert">
  ...
  Recuerda que los 
  <strong class="fst-italic">Pagos</strong> y <strong class="fst-italic">Préstamos</strong> 
  realizados serán registrados con la misma <strong class="fst-italic">Fecha</strong> del resumen pendiente.
